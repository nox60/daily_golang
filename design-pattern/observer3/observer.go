...
type ReaderType2 struct {
	name string
}

func NewReaderType2(name string) *ReaderType2 {
	return &ReaderType2{
		name: name,
	}
}

func (r *ReaderType2) Update(s *Subject) {
	fmt.Printf("%s receive %s\n", r.name, s.context)
}
